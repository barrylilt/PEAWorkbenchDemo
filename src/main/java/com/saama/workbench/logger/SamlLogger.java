 ...
 */
package com.saama.workbench.logger;
 ...
 *
 */
public class SamlLogger implements SAMLLogger {

    private final static Logger log = Logger.getLogger(SAMLDefaultLogger.class);
